...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    _specializationCtrl  = TextEditingController(text: p.userSpecialization);
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final Map<String, dynamic> fields = {
        ...
        if (widget.showSpecialization && _specializationCtrl.text.trim().isNotEmpty)
      ...
      // 5. Save name / phone / specialization
      await AppPreferences.instance.saveProfile(
        name: _nameCtrl.text.trim(),
        email: _emailCtrl.text.trim(),
        phone: _phoneCtrl.text.trim(),
        specialization: widget.showSpecialization
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _Field(
                    ...
                    action: widget.showSpecialization
